...
![ML Contract Violation Detector Banner](images/banner.png)
...
![Code Before Contract](images/example-before.png)
...
### After: Code with Generated Contract

![Code After Contract](images/example-after.png)
